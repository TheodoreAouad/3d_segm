...
for path_label in su.sort_by_regex(os.listdir(MESH_DIR)):
    for step_size in sorted(os.listdir(os.path.join(MESH_DIR, path_label))):
        full_path = os.path.join(MESH_DIR, path_label, step_size)
        ...
        if os.path.exists(volume_path):
            ...
            precut_volume = np.load(os.path.join(MESH_DIR, path_label, 'precut_volume_scalar.npy'))
