...
if True:  # loss and optimizer
    ...
    all_args['loss_data_str'] = [
        ...
        # "MaskedBCELoss",deep_morpho/saved_args/recompute_failed/args_morp_ops.py
        # "BCENormalizedLoss",
        "BCELoss",
        # "BCEWithLogitsLoss",
        # "CrossEntropyLoss",
...
if True:  # only keep relevent args
    good_args_path = "deep_morpho/saved_args/recompute_projected/args_good_0.txt"
    to_remove = []
