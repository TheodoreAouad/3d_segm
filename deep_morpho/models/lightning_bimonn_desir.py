...
from .bimonn_desir import ResnetDesirMerged, BimonnDesirResnetMerged, BimonnDesirResnetChannel
...
class LightningBimonnDesirResnetMerged(GenericLightningModel):
    model_class = BimonnDesirResnetMerged
...
class LightningBimonnDesirResnetChannel(LightningBimonnDesirResnetMerged):
    model_class = BimonnDesirResnetChannel