...
class InitSybiseBias(InitWeightsThenBias):
    ...
    def get_bias_from_weights(self, module):
        self.init_bias_value = self.input_mean * module.weight.mean() * torch.tensor(module._normalized_weights.shape[2:]).prod()
...
class InitBiseHeuristicWeights(InitBiasFixed):
    ...
    def init_weights(self, module):
        nb_params = torch.tensor(module._normalized_weights.shape[2:]).prod()
...
class InitBiseConstantVarianceWeights(InitBiasFixed):
    ...
    def init_weights(self, module):
        ...
        self.init_bias_value = self.input_mean * module._normalized_weights.sum((2, 3))
