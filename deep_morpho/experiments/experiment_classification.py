...
from .load_observables_fn import (
    ...
    load_observables_bimonn_desir_merged, load_observables_bimonn_desir_halfslice_segm
)
...
class ExperimentDesirSegmChan(ExperimentBase):
    def __init__(self, *args, **kwargs):
        kwargs["load_observables_fn"] = load_observables_bimonn_desir_merged
        kwargs["args_enforcers"] = kwargs.get("args_enforcers", []) + [ArgsDesirSegmChan()]
        super().__init__(*args, **kwargs)


class ExperimentDesirHalfsliceSegm(ExperimentBase):
    def __init__(self, *args, **kwargs):
        kwargs["load_observables_fn"] = load_observables_bimonn_desir_halfslice_segm
        kwargs["args_enforcers"] = kwargs.get("args_enforcers", []) + [ArgsSpalike()]
        super().__init__(*args, **kwargs)
