...
from deep_morpho_old.datasets import (
...
from deep_morpho_old.datasets.gray_to_channels_dataset import LevelsetValuesEqualIndex
# from deep_morpho_old.datasets.mnist_dataset import MnistMorphoDataset, MnistGrayScaleDataset, MnistClassifDataset
# from deep_morpho_old.datasets.fashionmnist_dataset import FashionMnistGrayScaleDataset
from deep_morpho_old.utils import set_seed
# from deep_morpho_old.datasets.generate_forms2 import get_random_diskorect
# from deep_morpho_old.datasets.generate_forms3 import get_random_rotated_diskorect
# from deep_morpho_old.datasets.diskorect_dataset import DiskorectDataset, MultiRectDataset
# from deep_morpho_old.datasets.axspa_roi_dataset import AxspaROISimpleDataset
# from deep_morpho_old.datasets.sticks_noised_dataset import AxspaROISimpleDataset
from deep_morpho_old.models import (
...
import deep_morpho_old.observables as obs
...
from deep_morpho_old.metrics import masked_dice, accuracy
from deep_morpho_old.env import CLASSIF_DATASETS, CLASSIF_DATASETS_CHANNEL, SPECIFIC_BIMONNS, SPECIFIC_BIMONNS_DENSE, SPECIFIC_BIMONNS_BISEL
from general.code_saver import CodeSaver


# Import args. Being able to use the CLI to decide the args path.
parser = argparse.ArgumentParser()
parser.add_argument("--args", default="deep_morpho_old/saved_args/sandbox/args_segm.py")
...
# from deep_morpho_old.args_segm import all_args
...
if __name__ == '__main__':
    ...
    code_saver = CodeSaver(
        src_path=os.getcwd(),
        temporary_path="deep_morpho_old/results/results_tensorboards",
    ...
    for args_idx, args in enumerate(all_args):
        ...
        logger = TensorBoardLogger("deep_morpho_old/results/results_tensorboards", name=name, default_hp_metric=False)
