...
from deep_morpho_old.binarization.bise_closest_selem import ClosestSelemEnum
from deep_morpho_old.observables import BinaryModeMetricClassif, BinaryModeMetricClassifChannel
from deep_morpho_old.datasets import MnistClassifDataset, MnistClassifChannelDataset, CIFAR10Dataset
...
exp_paths = "deep_morpho_old/results/results_tensorboards/"
...
logger = TensorBoardLogger(join("deep_morpho_old/results/test_results", tb_path), default_hp_metric=False)
