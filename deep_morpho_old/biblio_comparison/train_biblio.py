...
from deep_morpho_old.datasets.mnist_dataset import MnistMorphoDataset
...
from deep_morpho_old.datasets.axspa_roi_dataset import AxspaROIDataset, AxspaROISimpleDataset
import deep_morpho_old.observables as obs
import deep_morpho_old.biblio_comparison.observables as biblio_obs
...
from deep_morpho_old.metrics import masked_dice
from deep_morpho_old.biblio_comparison.args import final_args as all_args
from general.code_saver import CodeSaver
from deep_morpho_old.biblio_comparison.lightning_models import LightningLMorph, LightningSMorph, LightningAdaptativeMorphologicalLayer
...
if __name__ == '__main__':
    ...
    code_saver = CodeSaver(
        src_path=os.getcwd(),
        temporary_path="deep_morpho_old/results",
