...
from deep_morpho_old.models.activations import NormalizedTanh
from deep_morpho_old.initializer import InitBimonnEnum, InitBiseEnum
from deep_morpho_old.env import CLASSIF_DATASETS
from deep_morpho_old.experiments.parser import MultiParser
from .args_morp_ops import morp_operations
from deep_morpho_old.datasets.cifar_dataset import transform_default
...
all_args['dataset_path'] = [
    ...
    "data/deep_morpho_old/axspa_roi/axspa_roi.csv"
    # 'generate',
]
all_args['in_ram'] = [
    # False,
...
for idx, args in enumerate(all_args.multi_args):
    ...
    # already_seen_path = f"deep_morpho_old/results/results_tensorboards/{args['experiment_name']}/{args['atomic_element']}/{args['threshold_mode']['weight']}/{args['dataset']}/seen_args.txt"
