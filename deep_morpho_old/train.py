...
from deep_morpho_old import observables as obs
from deep_morpho_old.experiments import (
    MultiExperiment, Task
)

parser = argparse.ArgumentParser()
parser.add_argument("--args", default="deep_morpho_old/saved_args/sandbox/args.py")
...
all_experiments = MultiExperiment(
    ...
    dest_dir="deep_morpho_old/results/results_tensorboards",
    stop_on_error=True,
